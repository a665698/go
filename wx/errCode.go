...
var errCode = map[int]string{
	...
	9001010:"失败",
	9001020:"不合法",
	9001021:"设备激活率低于 50% ，不能新增设备",
	9001022:"申请数不合法，必须为大于 0 的数字",
	9001023:"在审核中的设备 ID 申请",
	9001024:"查询设备 ID 数量不能超过 50",
	9001025:" ID 不合法",
	9001026:" ID 不合法",
	9001027:"参数不合法",
	9001028:"删除页面 ID 数量不能超过 10",
	9001029:"已应用在设备中，请先解除应用关系再删除",
	9001030:"查询页面 ID 数量不能超过 50",
	9001031:"区间不合法",
	9001032:"设备与页面的绑定关系参数错误",
	9001033:" ID 不合法",
	9001034:"备注信息过长",
	9001035:"申请参数不合法",
	9001036:"起始值 begin 不合法",
}
